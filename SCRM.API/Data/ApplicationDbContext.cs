...
namespace SCRM.Data
{
    public class ApplicationDbContext : DbContext
    {
        ...
        // 业务实体集合
        public DbSet<Entities.User> BusinessUsers { get; set; }
        public DbSet<Order> BusinessOrders { get; set; }

        // 身份验证和授权实体集合
        public DbSet<Models.Identity.User> IdentityUsers { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // 配置业务实体 User
            modelBuilder.Entity<SCRM.Entities.User>(entity =>
            {
            ...
            modelBuilder.Entity<Order>(entity =>
            {
                ...
                // 配置外键关系
                entity.HasOne<SCRM.Entities.User>()
                      .WithMany()
